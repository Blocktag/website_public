...
var HomePageTemplate = function HomePageTemplate(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: "w-full sm:w-1/3 sm:order-1",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 108,
    ...
    className: "w-full px-12 pb-8 text-center text-gray-100 lg:pl-24 sm:pl-0 md:pr-12 sm:pr-4 sm:text-right sm:w-1/3",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 113,
    ...
    className: "w-full px-12 pb-8 text-center text-gray-100 lg:pr-24 sm:pr-0 md:pl-12 sm:pl-4 sm:text-left sm:w-1/3",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 124,
...
//# sourceMappingURL=cms.dc440dacddf776471eb6.hot-update.js.map