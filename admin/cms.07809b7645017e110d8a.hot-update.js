...
var HomePageTemplate = function HomePageTemplate(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: "flex flex-wrap items-center py-2 border-b-2 border-teal-500 sm:border-b sm:mx-24 sm:flex-no-wrap",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50,
    ...
    className: "w-full px-2 py-1 mr-3 leading-tight text-gray-200 bg-transparent border-b border-b-2 border-teal-500 appearance-none sm:border-none focus:outline-none",
    type: "text",
...
//# sourceMappingURL=cms.07809b7645017e110d8a.hot-update.js.map