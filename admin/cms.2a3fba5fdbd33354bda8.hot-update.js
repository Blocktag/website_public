...
var HomePageTemplate = function HomePageTemplate(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: "flex-shrink-0 px-8 py-1 text-sm text-white bg-teal-500 border-4 border-teal-500 rounded sm:w-full hover:bg-teal-700 hover:border-teal-700",
    type: "button",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=cms.2a3fba5fdbd33354bda8.hot-update.js.map