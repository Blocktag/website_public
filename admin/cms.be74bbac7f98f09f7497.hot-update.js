...
var HomePageTemplate = function HomePageTemplate(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: "w-full px-2 py-1 my-4 sm:my-0 mr-3 text-gray-200 bg-transparent border-b border-b-2 border-teal-500 appearance-none sm:leading-tight sm:border-none focus:outline-none",
    type: "text",
    ...
    className: "w-full px-2 py-1 my-4 mr-3 text-gray-200 bg-transparent border-b border-b-2 border-teal-500 appearance-none sm:my-0 sm:leading-tight sm:border-none focus:outline-none",
    type: "text",
    ...
    className: "flex-shrink-0 px-8 py-1 my-4 text-sm text-white bg-teal-500 border-4 border-teal-500 rounded sm:my-0 hover:bg-teal-700 hover:border-teal-700",
    type: "button",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=cms.be74bbac7f98f09f7497.hot-update.js.map