...
var Showcase = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      className: (activeEl === 0 ? 'text-gray-400' : 'text-teal-500 hover:text-teal-600') + ' text-3xl m-4 lg:m-16 flex-shrink transition ease-out duration-500',
      onClick: this.onLeft,
      __self: this,
      __source: {
        fileName: _jsxFileName,
      ...
      className: (activeEl === data.length - 1 ? 'text-gray-400' : 'text-teal-500 hover:text-teal-600') + ' text-3xl m-4 lg:m-16 flex-shrink transition ease-out duration-500',
...
//# sourceMappingURL=cms.65cc8f2035ffc3fce18c.hot-update.js.map