...
var HomePageTemplate = function HomePageTemplate(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: "px-8 py-1 my-4 text-sm text-white bg-teal-500 border-4 border-teal-500 rounded sm:flex-shrink-0 sm:my-0 hover:bg-teal-700 hover:border-teal-700",
    type: "button",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=cms.0588a5685cfe75f4be71.hot-update.js.map