...
var AboutPageTemplate = function AboutPageTemplate(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "flex flex-col bg-indigo-100",
    __self: _this,
    __source: {
    ...
    className: "flex flex-wrap items-center py-12 my-12 text-center text-gray-800",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17,
    ...
    className: "m-12 text-4xl leading-tight text-center text-gray-800",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
  ...
  }, team.slice(0, 3).map(TeamMemberBig), team.slice(3).map(TeamMemberSmall))));
};
...
var TeamMemberBig = function TeamMemberBig(_ref2) {
  var name = _ref2.name,
      img = _ref2.img,
      title = _ref2.title,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
    ...
    className: "flex items-stretch w-full max-w-xs p-6 md:w-1/3",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
    ...
    className: "flex-1 overflow-hidden bg-gray-100 rounded shadow-md transition transition-shadow ease-in-out hover:shadow-xl duration-500",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50,
  ...
  }, name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h3", {
...
var TeamMemberSmall = function TeamMemberSmall(_ref3) {
  var name = _ref3.name,
      img = _ref3.img,
      title = _ref3.title,
      short_description = _ref3.short_description,
      url = _ref3.url;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
    key: name,
    href: url,
...
(function () {
  ...
  reactHotLoader.register(TeamMemberBig, "TeamMemberBig", "/Users/allie/src/blocktag/website/src/components/AboutPageTemplate/index.js");
  reactHotLoader.register(TeamMemberSmall, "TeamMemberSmall", "/Users/allie/src/blocktag/website/src/components/AboutPageTemplate/index.js");
...
//# sourceMappingURL=cms.dc393b54188045ccf1ad.hot-update.js.map