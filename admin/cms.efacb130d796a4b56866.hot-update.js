...
var HomePageTemplate = function HomePageTemplate(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: "w-full px-8 py-1 my-4 text-sm text-white bg-teal-500 border-4 border-teal-500 rounded sm:flex-shrink-0 sm:my-0 hover:bg-teal-700 hover:border-teal-700",
    type: "button",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=cms.efacb130d796a4b56866.hot-update.js.map