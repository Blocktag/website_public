...
/***/ "./src/components/forms/ContactForm/validationInquirySchema.js":
/*!*********************************************************************!*\
  !*** ./src/components/forms/ContactForm/validationInquirySchema.js ***!
  \*********************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! yup */ "./node_modules/yup/lib/index.js");
...
var validationSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  name: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().min(2, 'Too Short!').max(50, 'Too Long!').required('Name is Required!'),
  email: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().email('Enter a Valid Email!').required('Email is Required!')
});
...
(function () {
  ...
  reactHotLoader.register(validationSchema, "validationSchema", "/Users/allie/src/blocktag/website/src/components/forms/ContactForm/validationInquirySchema.js");
  reactHotLoader.register(_default, "default", "/Users/allie/src/blocktag/website/src/components/forms/ContactForm/validationInquirySchema.js");
})();
...
//# sourceMappingURL=cms.487ef5b24990b98cef40.hot-update.js.map