...
var Showcase = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2__["Fragment"], {
      ...
      className: (activeEl === 0 ? "text-gray-400" : "text-teal-500") + "text-3xl m-16 flex-shrink",
      onClick: this.onLeft,
      __self: this,
      __source: {
        fileName: _jsxFileName,
      ...
      className: (activeEl === data.length - 1 ? "text-gray-400" : "text-teal-500") + "text-3xl m-16 flex-shrink",
...
//# sourceMappingURL=cms.0bfe0349606ffc07143a.hot-update.js.map